...
{
    public List<DynamicPartInLocalizedText> dp;
}
[Serializable]
...
public static class LocalizationTextCreator
{
    ...
    public static LocalizationText Add(GameObject g, string key, params object[] DynamicParts)
    {
        ...
        if (g.GetComponent<LocalizationText>() != null) return null;


        g.SetActive(false);

        LocalizationText lt = g.AddComponent<LocalizationText>();
